        ...
        Column(
            ...
            when (postState) {
                ...
                is Resource.Loading<List<PostResponseModel>> -> {
                    ...
                    Column(modifier = Modifier.verticalScroll(rememberScrollState()).padding(horizontal = 10.dp)) {
                        Text(
                            "내가 작성한 글",
                            fontSize = 17.sp,
...
fun MyMeetingBoardItem(
    ...
    Box(
        modifier = Modifier
            ...
            }.padding(top = 10.dp).border(width = 1.dp, color = Color(0xffd9d9d9), shape = RoundedCornerShape(15.dp))
    ) {
        Column(
            Modifier
